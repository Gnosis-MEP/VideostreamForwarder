...
class TestVideoStreamForwarder(MockedEventDrivenServiceStreamTestCase):
    ...
    SERVICE_CLS = VideoStreamForwarder
    ...
    MOCKED_STREAMS_DICT = {
        SERVICE_STREAM_KEY: [],
        'cg-VideoStreamForwarder': MOCKED_CG_STREAM_DICT,
    }

    @patch('videostreamforwarder.service.VideoStreamForwarder.process_event_type')
